...
import Card from "../../Componets/CardFiles/CardFiles.jsx";
    ...
    return (
        ...
        <div className="container-admin">
            ...
            <Card
                ...
                title="Lake"
                description="The soothing sound of the Lake can have several positive effects on the mind and body of people, for example: Stress reduction, improvement of mood, facilitates sleep."
            />
            <Card
                ...
                title="Waterfall"
                description="The soothing sound of the Waterfall can have several positive effects on the mind and body of people, for example: Stress reduction, improvement of mood, facilitates sleep."
            />
            <Card
                ...
                title="Guitar"
                description="The soothing sound of the Guitar can have several positive effects on the mind and body of people, for example: Stress reduction, improvement of mood, facilitates sleep."
            />
            <Card
                ...
                title="Piano"
                description="The soothing sound of the Piano can have several positive effects on the mind and body of people, for example: Stress reduction, improvement of mood, facilitates sleep."
            />
            <Card
                ...
                title="Violin"
                description="The soothing sound of the Violin can have several positive effects on the mind and body of people, for example: Stress reduction, improvement of mood, facilitates sleep."
            />
            <Card
                ...
                title="Acordeon"
                description="The soothing sound of the Acordeon can have several positive effects on the mind and body of people, for example: Stress reduction, improvement of mood, facilitates sleep."
            />
        </div>
